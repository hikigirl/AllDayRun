		...
		<!-- 헤더 -->
  		...
  		<div class="content-wrapper">
    		...
    		<div class="main-content" id="">
                ...
                <form method="POST" action="/alldayrun/crewboardaddok.do" enctype="multipart/form-data">
                    ...
                    <div class="form-buttons">
                        ...
                        <button type="button" onclick="location.href='/alldayrun/crewboardlist.do'">취소</button>
                    </div>
                </form>
            </div>
    		</div>
